...
<form method="post" class="form-signin">
    ...
    <h1 class="h3 mb-3 font-weight-normal">
        <a href="http://amak.sesc2018.dev.sesc-nsu.ru/index.php?page=log-in#" class="stretched-link ">Вход/</a>
        <a href="http://amak.sesc2018.dev.sesc-nsu.ru/index.php?page=register" class="stretched-link ">Регистрация</a>
    </h1>
    ...
    <p><span style="color: #ac1d07;"><?=$message ?></span></p>
